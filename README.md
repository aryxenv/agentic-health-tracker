...
clone the repo, open the folder in the agent of your choice and ask it anything, or click on the github copilot icon in the top right of this github page to ask it questions about the codebase.
